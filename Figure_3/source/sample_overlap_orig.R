...
samples_comp_original_low <- final_collector
samples_comp_original_matrix_low <- final_collector_matrix
...
samples_comp_original_high <- final_collector
samples_comp_original_matrix_high <- final_collector_matrix

rm(collector_high, collector_low, final_collector, final_collector_matrix, int_collector, i, j, sample, sample_high, sample_low, target, test)